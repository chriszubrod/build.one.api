...
| `DELETE` | `/api/v1/delete/cost-code/{public_id}` | No body read | Service fetches by public ID then calls `repo.delete_by_id` and returns the deleted record as dict. |
