...
# Local Imports
from workflows.capabilities.base import Capability

if TYPE_CHECKING:
    from workflows.capabilities.llm import LlmCapabilities
    from workflows.capabilities.document import DocumentCapabilities
    from workflows.capabilities.email import EmailCapabilities
    from workflows.capabilities.entity import EntityCapabilities
    from workflows.capabilities.sharepoint import SharePointCapabilities
    from workflows.capabilities.storage import StorageCapabilities
    from workflows.capabilities.sync import SyncCapabilities
