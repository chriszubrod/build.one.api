...
BEGIN
    ...
    WHERE
        ...
        OR b.[CreatedByUserId] = @ActorUserId
        OR b.[Id] IN (
            SELECT bli.[BillId]
...
BEGIN
    ...
    WHERE
        @ActorIsSystemAdmin = 1
        OR e.[CreatedByUserId] = @ActorUserId
        OR e.[Id] IN (
            SELECT eli.[ExpenseId]
...
PRINT 'Gap 1 v2 (IN-subquery + CreatedByUserId) applied to Bill / BillCredit / Expense.';
