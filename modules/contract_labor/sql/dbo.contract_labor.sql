...
DROP TABLE IF EXISTS dbo.[ContractLabor];
GO
...
DROP TABLE IF EXISTS dbo.[ContractLaborLineItem];
GO
...
DROP PROCEDURE IF EXISTS CreateContractLabor;
GO

CREATE PROCEDURE CreateContractLabor
(
...
DROP PROCEDURE IF EXISTS ReadContractLabors;
GO

CREATE PROCEDURE ReadContractLabors
AS
BEGIN
    BEGIN TRANSACTION;
...
DROP PROCEDURE IF EXISTS ReadContractLaborById;
GO

CREATE PROCEDURE ReadContractLaborById
(
    @Id BIGINT
)
AS
...
DROP PROCEDURE IF EXISTS ReadContractLaborByPublicId;
GO

CREATE PROCEDURE ReadContractLaborByPublicId
(
...
DROP PROCEDURE IF EXISTS ReadContractLaborsByVendorId;
GO

CREATE PROCEDURE ReadContractLaborsByVendorId
(
    @VendorId BIGINT
)
AS
...
DROP PROCEDURE IF EXISTS ReadContractLaborsByBillingPeriod;
GO

CREATE PROCEDURE ReadContractLaborsByBillingPeriod
(
...
DROP PROCEDURE IF EXISTS ReadContractLaborsByStatus;
GO

CREATE PROCEDURE ReadContractLaborsByStatus
(
    @Status NVARCHAR(20)
)
AS
...
DROP PROCEDURE IF EXISTS ReadContractLaborsByImportBatchId;
GO

CREATE PROCEDURE ReadContractLaborsByImportBatchId
(
...
DROP PROCEDURE IF EXISTS ReadContractLaborsPaginated;
GO

CREATE PROCEDURE ReadContractLaborsPaginated
(
    @PageNumber INT = 1,
    @PageSize INT = 50,
...
DROP PROCEDURE IF EXISTS CountContractLabors;
GO

CREATE PROCEDURE CountContractLabors
(
    @SearchTerm NVARCHAR(255) = NULL,
    @VendorId BIGINT = NULL,
    @ProjectId BIGINT = NULL,
...
DROP PROCEDURE IF EXISTS UpdateContractLaborById;
GO

CREATE PROCEDURE UpdateContractLaborById
(
    @Id BIGINT,
    @RowVersion BINARY(8),
    @VendorId BIGINT NULL,
...
DROP PROCEDURE IF EXISTS DeleteContractLaborById;
GO

CREATE PROCEDURE DeleteContractLaborById
(
    @Id BIGINT
)
AS
...
DROP PROCEDURE IF EXISTS ReadLastRateForVendor;
GO

CREATE PROCEDURE ReadLastRateForVendor
(
    @VendorId BIGINT
)
AS
...
DROP PROCEDURE IF EXISTS UpdateContractLaborStatusByIds;
GO

CREATE PROCEDURE UpdateContractLaborStatusByIds
(
...
DROP PROCEDURE IF EXISTS ReadContractLaborDailySummary;
GO

CREATE PROCEDURE ReadContractLaborDailySummary
(
...
DROP PROCEDURE IF EXISTS CreateContractLaborLineItem;
GO

CREATE PROCEDURE CreateContractLaborLineItem
(
...
DROP PROCEDURE IF EXISTS ReadContractLaborLineItemsByContractLaborId;
GO

CREATE PROCEDURE ReadContractLaborLineItemsByContractLaborId
(
    @ContractLaborId BIGINT
)
AS
...
DROP PROCEDURE IF EXISTS ReadContractLaborLineItemById;
GO

CREATE PROCEDURE ReadContractLaborLineItemById
(
    @Id BIGINT
)
AS
...
DROP PROCEDURE IF EXISTS ReadContractLaborLineItemByPublicId;
GO

CREATE PROCEDURE ReadContractLaborLineItemByPublicId
(
    @PublicId UNIQUEIDENTIFIER
)
AS
...
DROP PROCEDURE IF EXISTS UpdateContractLaborLineItemById;
GO

CREATE PROCEDURE UpdateContractLaborLineItemById
(
    @Id BIGINT,
    @RowVersion BINARY(8),
    @LineDate DATE NULL,
...
DROP PROCEDURE IF EXISTS DeleteContractLaborLineItemById;
GO

CREATE PROCEDURE DeleteContractLaborLineItemById
(
    @Id BIGINT
)
AS
...
DROP PROCEDURE IF EXISTS DeleteContractLaborLineItemsByContractLaborId;
GO

CREATE PROCEDURE DeleteContractLaborLineItemsByContractLaborId
(
    @ContractLaborId BIGINT
)
AS
...
DROP PROCEDURE IF EXISTS UpdateContractLaborBillInfo;
GO

CREATE PROCEDURE UpdateContractLaborBillInfo
(
    @Id BIGINT,
    @RowVersion BINARY(8),
