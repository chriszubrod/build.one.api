...
# Local Imports
from modules.taxpayer_attachment.business.model import TaxpayerAttachment
...
class TaxpayerAttachmentService:
    ...
    def create(self, *, taxpayer_public_id: str, attachment_public_id: str) -> TaxpayerAttachment:
        """
    ...
    def delete_by_public_id(self, public_id: str) -> Optional[TaxpayerAttachment]:
        """
