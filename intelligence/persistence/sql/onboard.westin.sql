-- Onboard Westin Parker as an Intern.
--
-- Intern role already exists and is pre-configured. Idempotent.
--
-- RUN:
--   .venv/bin/python scripts/run_sql.py intelligence/persistence/sql/onboard.westin.sql

DECLARE @Now DATETIME2 = SYSUTCDATETIME();

DECLARE @Username NVARCHAR(100)   = 'parkerwp';
DECLARE @PasswordHash NVARCHAR(255) =
    '$2b$12$EpqdA61SS/18S2LaNz.NjuYr3pL5GOsZOQgzNSKTBfaxRSmvXGZq.';
DECLARE @Firstname NVARCHAR(50)   = 'Westin';
DECLARE @Lastname  NVARCHAR(255)  = 'Parker';
DECLARE @Email     NVARCHAR(255)  = 'westonejohseparker@icloud.com';
