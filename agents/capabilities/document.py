...
class DocumentCapabilities(Capability):
    ...
    def extract_from_bytes(
        ...
        try:
            ...
            logger.exception("Error in extract_from_bytes")
    ...
    def extract_from_url(
        ...
        try:
            client = self._get_client()
            result = client.extract_document_from_url(document_url=document_url)
            ...
            logger.exception("Error in extract_from_url")
            return CapabilityResult.fail(error=str(e))
    ...
    def extract_invoice_fields(
        ...
        try:
            ...
            logger.exception("Error in extract_invoice_fields")
            return CapabilityResult.fail(error=str(e))
