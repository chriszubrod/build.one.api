-- Onboard Emilson Cordova as a Field Crew user.
--
-- Prerequisite: seed.field_crew_role.sql must have been run.
-- Idempotent — safe to re-run.
--
-- RUN:
--   .venv/bin/python scripts/run_sql.py intelligence/persistence/sql/onboard.emilson.sql

DECLARE @Now DATETIME2 = SYSUTCDATETIME();

DECLARE @Username NVARCHAR(100)   = 'cordovaem';
DECLARE @PasswordHash NVARCHAR(255) =
    '$2b$12$.tzo.1yaDmsXLfzmjUJmy.2m6z8i0Mu3P7DOuYCKLAwit1vw8wuJe';
DECLARE @Firstname NVARCHAR(50)   = 'Emilson';
DECLARE @Lastname  NVARCHAR(255)  = 'Cordova';
DECLARE @Email     NVARCHAR(255)  = 'emisoncordova@gmail.com';
