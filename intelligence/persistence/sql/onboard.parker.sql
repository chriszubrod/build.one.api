-- Onboard Parker Hazen as a Field Crew user.
--
-- Prerequisite: seed.field_crew_role.sql must have been run.
-- Idempotent — safe to re-run.
--
-- RUN:
--   .venv/bin/python scripts/run_sql.py intelligence/persistence/sql/onboard.parker.sql

DECLARE @Now DATETIME2 = SYSUTCDATETIME();

DECLARE @Username NVARCHAR(100)   = 'hazenph';
DECLARE @PasswordHash NVARCHAR(255) =
    '$2b$12$qLxHocRPraKZuLkW4KCx..kPA36xjNGw3fNF2Nfi5Q8sTIvfbPKXy';
DECLARE @Firstname NVARCHAR(50)   = 'Parker';
DECLARE @Lastname  NVARCHAR(255)  = 'Hazen';
DECLARE @Email     NVARCHAR(255)  = 'parker@48-performance.com';
