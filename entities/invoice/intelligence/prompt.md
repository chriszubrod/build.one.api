...
> **Last verified against code:** 2026-07-13 (full claim-by-claim audit; every service/connector/SQL reference below was checked against the codebase on that date). When editing this file, re-verify the code references you touch and update this date.
