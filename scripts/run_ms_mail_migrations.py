...
SQL_FILES = [
    "integrations/ms/mail/message/sql/ms.message.sql",
    "integrations/ms/mail/message/connector/bill/sql/ms.message_bill.sql",
    "integrations/ms/mail/message/connector/vendor/sql/ms.message_vendor.sql",
    "integrations/ms/mail/message/connector/project/sql/ms.message_project.sql",
]
...
def run_sql_file(cursor, filepath: str) -> bool:
    ...
    try:
        ...
        # Handle GO with optional whitespace/newlines
        import re
