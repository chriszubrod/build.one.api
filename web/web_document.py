...
from agents.document_crew import run_crew
from utils.normalize import normalize_invoice_fields

pytesseract.pytesseract.tesseract_cmd = '/opt/homebrew/bin/tesseract'

web_document_bp = Blueprint(
    'web_document',
    __name__,
...
@web_document_bp.route('/document', methods=["GET"])
def get_document():
    return render_template('document.html')


@web_document_bp.route('/document', methods=["POST"])
