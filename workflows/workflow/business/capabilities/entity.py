...
# Local Imports
from workflows.workflow.business.capabilities.base import Capability, CapabilityResult, ERROR_VALIDATION
...
class EntityCapabilities(Capability):
    ...
    def match_vendor(
        ...
        try:
            ...
            return self._handle_error(e, "match_vendor")
    ...
    def match_project(
        ...
        try:
            ...
            return self._handle_error(e, "match_project")
    ...
    def create_bill(
        ...
        try:
            ...
            return self._handle_error(e, "create_bill")
    ...
    def link_attachment_to_bill_line_item(
        ...
        try:
            ...
            return self._handle_error(e, "link_attachment_to_bill_line_item")
    ...
    def get_known_vendor_emails(self, tenant_id: int) -> CapabilityResult:
        ...
        try:
            ...
            return self._handle_error(e, "get_known_vendor_emails")
    ...
    def get_known_vendor_names(self, tenant_id: int) -> CapabilityResult:
        ...
        try:
            ...
            return self._handle_error(e, "get_known_vendor_names")
    ...
    def get_known_project_names(self, tenant_id: int) -> CapabilityResult:
        ...
        try:
            ...
            return self._handle_error(e, "get_known_project_names")
    ...
    def get_projects_for_matching(self, tenant_id: int) -> CapabilityResult:
        ...
        try:
            ...
            return self._handle_error(e, "get_projects_for_matching")
    ...
    def get_sub_cost_codes(self, tenant_id: int) -> CapabilityResult:
        ...
        try:
            ...
            return self._handle_error(e, "get_sub_cost_codes")
    ...
    def match_sub_cost_code(
        ...
        try:
            ...
            return self._handle_error(e, "match_sub_cost_code")
    ...
    def get_default_payment_term(self, tenant_id: int) -> CapabilityResult:
        ...
        try:
            ...
            return self._handle_error(e, "get_default_payment_term")
