...
class BillLineItemAttachmentService:
    ...
    def create(self, *, bill_line_item_public_id: str, attachment_public_id: str) -> BillLineItemAttachment:
        """
    ...
    def delete_by_public_id(self, public_id: str) -> Optional[BillLineItemAttachment]:
        """
