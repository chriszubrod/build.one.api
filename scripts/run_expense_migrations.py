...
SQL_FILES = [
    "services/expense/sql/dbo.expense.sql",
    "services/expense_line_item/sql/dbo.expense_line_item.sql",
    "services/expense_line_item_attachment/sql/dbo.expense_line_item_attachment.sql",
]
...
def main():
    print("\n" + "="*60)
    print("EXPENSE MODULE SQL MIGRATIONS")
    print("="*60)
