...
@dataclass
class ExpenseAgentRun:
    """Tracks a single execution of the expense folder processing agent."""
...
class ProcessingResult:
    """Result of an expense folder processing run."""
    files_found: int = 0
    files_processed: int = 0
    files_skipped: int = 0
    expenses_created: int = 0
...
class FilenameParsedData:
    """Data extracted from an expense filename (8-segment convention)."""
