-- Onboard Elmer Cordova as a Field Crew user.
--
-- Prerequisite: seed.field_crew_role.sql must have been run.
-- Idempotent — safe to re-run.
--
-- RUN:
--   .venv/bin/python scripts/run_sql.py intelligence/persistence/sql/onboard.elmer.sql

DECLARE @Now DATETIME2 = SYSUTCDATETIME();

DECLARE @Username NVARCHAR(100)   = 'cordovael';
DECLARE @PasswordHash NVARCHAR(255) =
    '$2b$12$E.c/PNkqkZBNTncC3vqdw.cG.JZQLjzK0LJiUc3Vz7rKGQSG43eom';
DECLARE @Firstname NVARCHAR(50)   = 'Elmer';
DECLARE @Lastname  NVARCHAR(255)  = 'Cordova';
DECLARE @Email     NVARCHAR(255)  = 'cordovaelmer1604@gmail.com';
...
-- ─── 7. UserProject bulk (active projects, last 12 months) ──────────────
