...
ADD 
    ...
    [ExtractedDatetime] DATETIME2(3) NULL;
GO
...
DROP PROCEDURE IF EXISTS UpdateAttachmentExtraction;
GO

CREATE PROCEDURE UpdateAttachmentExtraction
(
    @Id BIGINT,
...
DROP PROCEDURE IF EXISTS ReadAttachmentsPendingExtraction;
GO

CREATE PROCEDURE ReadAttachmentsPendingExtraction
AS
BEGIN
    BEGIN TRANSACTION;
