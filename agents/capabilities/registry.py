...
if TYPE_CHECKING:
    from agents.capabilities.llm import LlmCapabilities
    from agents.capabilities.document import DocumentCapabilities
    from agents.capabilities.email import EmailCapabilities
    from agents.capabilities.entity import EntityCapabilities
    from agents.capabilities.sharepoint import SharePointCapabilities
    from agents.capabilities.storage import StorageCapabilities
    from agents.capabilities.sync import SyncCapabilities
