-- Onboard Michael Jacobson as a Field Crew user.
--
-- Prerequisite: seed.field_crew_role.sql must have been run.
-- Idempotent — safe to re-run.
--
-- RUN:
--   .venv/bin/python scripts/run_sql.py intelligence/persistence/sql/onboard.michael.sql

DECLARE @Now DATETIME2 = SYSUTCDATETIME();

DECLARE @Username NVARCHAR(100)   = 'jacobsonmj';
DECLARE @PasswordHash NVARCHAR(255) =
    '$2b$12$a1Ey5v8WIG/CzkTv3YQzseR/qxSd/qD3iSh06GzS/vXjpAqCanuCS';
DECLARE @Firstname NVARCHAR(50)   = 'Michael';
DECLARE @Lastname  NVARCHAR(255)  = 'Jacobson';
DECLARE @Email     NVARCHAR(255)  = 'mjake440@gmail.com';
