    ...
    def _from_db(self, row: pyodbc.Row) -> Optional[QboVendorCredit]:
        ...
        try:
            return QboVendorCredit(
                ...
                total_amt=to_decimal_or_none(row.TotalAmt),
    ...
    def _line_from_db(self, row: pyodbc.Row) -> Optional[QboVendorCreditLine]:
        ...
        try:
            return QboVendorCreditLine(
                ...
                amount=to_decimal_or_none(row.Amount),
                ...
                unit_price=to_decimal_or_none(row.UnitPrice),
                qty=to_decimal_or_none(row.Qty),
        ...
        try:
            with get_connection() as conn:
                ...
                call_procedure(cursor, "CreateQboVendorCredit", {
                    ...
                    "TotalAmt": to_decimal_or_none(vendor_credit.total_amt),
        ...
        try:
            with get_connection() as conn:
                ...
                call_procedure(cursor, "CreateQboVendorCreditLine", {
                    ...
                    "Amount": to_decimal_or_none(line.amount),
                    ...
                    "UnitPrice": to_decimal_or_none(line.unit_price),
                    "Qty": to_decimal_or_none(line.qty),
