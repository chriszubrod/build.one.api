...
# U-137: dbo.organization.sql reconciled to migration 002 (seven Phase-1 sprocs) and made sole home of all 7 Organization sprocs — whole-file guard.
...
# U-148: dbo.attachment.sql reconciled (CreateAttachment <- gap2_adjacent_threading Phase-Adjacent body) and made sole home of all Attachment sprocs (10, now 12 after U-279's ReadAttachmentByQboIdAndRealmId) — whole-file guard; also stubs the CreateAttachment copy in gap2_adjacent_threading.sql and the five read-sproc copies in update_procedures_with_extraction.sql.
