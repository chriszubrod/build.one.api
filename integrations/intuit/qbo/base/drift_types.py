...
KNOWN_DRIFT_TYPES: FrozenSet[str] = frozenset({
    ...
    DRIFT_QBO_VOIDED, DRIFT_INVOICE_DRAW_MISMATCH,
    DRIFT_ORPHANED_BILL_BILL_MAPPING, DRIFT_DUPLICATE_QBO_BILL_DOCNUMBER,
    DRIFT_DUPLICATE_QBO_ITEM, DRIFT_ORPHANED_ITEM_COST_CODE_MAPPING,
    DRIFT_ORPHAN_BILLCREDIT_HEADER, DRIFT_ORPHANED_VC_BILLCREDIT_MAPPING,
    ...
    DRIFT_ORPHANED_VENDOR_VENDOR_MAPPING, DRIFT_WATERMARK_HOLD_BOUND_EXCEEDED,
})
