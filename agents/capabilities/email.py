...
class EmailCapabilities(Capability):
    ...
    def get_new_messages(
        ...
        try:
            ...
            logger.exception("Error in get_new_messages")
    ...
    def get_message(
        ...
        try:
            ...
            logger.exception("Error in get_message")
            return CapabilityResult.fail(error=str(e))
    ...
    def get_thread_messages(
        ...
        try:
            ...
            logger.exception("Error in get_thread_messages")
            return CapabilityResult.fail(error=str(e))
    ...
    def send_as_user(
        ...
        try:
            ...
            logger.exception("Error in send_as_user")
            return CapabilityResult.fail(error=str(e))
    ...
    def reply_to_message(
        ...
        try:
            ...
            logger.exception("Error in reply_to_message")
            return CapabilityResult.fail(error=str(e))
    ...
    def download_attachment(
        ...
        try:
            ...
            logger.exception("Error in download_attachment")
            return CapabilityResult.fail(error=str(e))
