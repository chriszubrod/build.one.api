...
class SharePointCapabilities(Capability):
    ...
    def upload_to_project_folder(
        ...
        try:
            ...
            logger.exception("Error in upload_to_project_folder")
            return CapabilityResult.fail(error=str(e))
    ...
    def append_worksheet_rows(
        ...
        try:
            ...
            self._log_result("append_worksheet_rows", result)
            return result
            
        except Exception as e:
            logger.exception("Error in append_worksheet_rows")
            return CapabilityResult.fail(error=str(e))
    ...
    def append_to_project_worksheet(
        ...
        try:
            ...
            logger.exception("Error in append_to_project_worksheet")
            return CapabilityResult.fail(error=str(e))
