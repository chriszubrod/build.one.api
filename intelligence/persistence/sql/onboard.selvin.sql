-- Onboard Selvin Cordova as a Field Crew user.
--
-- Prerequisite: seed.field_crew_role.sql must have been run.
-- Idempotent — safe to re-run.
--
-- RUN:
--   .venv/bin/python scripts/run_sql.py intelligence/persistence/sql/onboard.selvin.sql

DECLARE @Now DATETIME2 = SYSUTCDATETIME();

DECLARE @Username NVARCHAR(100)   = 'cordovase';
DECLARE @PasswordHash NVARCHAR(255) =
    '$2b$12$dVLVrYP6CWxl7EKRn8jYCe1EZmXPr.M6GEsz54UzEj4YcqWWmxWs6';
DECLARE @Firstname NVARCHAR(50)   = 'Selvin';
DECLARE @Lastname  NVARCHAR(255)  = 'Cordova';
DECLARE @Email     NVARCHAR(255)  = 'selvincordova1989@gmail.com';
...
IF NOT EXISTS (SELECT 1 FROM dbo.UserRole WHERE UserId = @UserId AND RoleId = @FieldCrewRoleId)
BEGIN
