-- Onboard Wilmer Diaz as a Field Crew user.
--
-- Prerequisite: seed.field_crew_role.sql must have been run.
-- Idempotent — safe to re-run.
--
-- RUN:
--   .venv/bin/python scripts/run_sql.py intelligence/persistence/sql/onboard.wilmer.sql

DECLARE @Now DATETIME2 = SYSUTCDATETIME();

DECLARE @Username NVARCHAR(100)   = 'diazwd';
DECLARE @PasswordHash NVARCHAR(255) =
    '$2b$12$nv6VrDfuLvALG2Xjgcs20OQOmRLHknrTf9OgYqZV6XOVjB0Uc2Lm.';
DECLARE @Firstname NVARCHAR(50)   = 'Wilmer';
DECLARE @Lastname  NVARCHAR(255)  = 'Diaz';
DECLARE @Email     NVARCHAR(255)  = 'diaznajarwilmer@gmail.com';
