...
class LlmProviderRouter:
    ...
    def _initialize_providers(self) -> None:
        ...
        if not self.cloud_only:
            try:
                from workflows.workflow.business.capabilities.llm_providers.ollama import OllamaProvider
        ...
        try:
            from workflows.workflow.business.capabilities.llm_providers.azure import AzureOpenAIProvider
